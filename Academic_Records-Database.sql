...
(5, 'MECH', 'Open Elective', 2023),
(5, 'MECH', 'Open Elective Humanities', 2023),
(5, 'MECH', 'Industrial Electronics Laboratory', 2023),
(6, 'MECH', 'Elements of Machine Design', 2023),
(6, 'MECH', 'Energy Conversion-II', 2023),
(6, 'MECH', 'Computer Aided Engineering', 2023),
(6, 'MECH', 'Departmental Elective-II', 2023),
(6, 'MECH', 'Open Elective', 2023),
(6, 'MECH', 'Open Elective Management', 2023),
(6, 'MECH', 'Mini Project', 2023),
(6, 'MECH', 'MNCC-Business Communication', 2023),
(1, 'COMPS', 'Applied Mathematics 1', 2022),
(1, 'COMPS', 'Engineering Chemistry', 2022),
(1, 'COMPS', 'Engineering Drawing', 2022),
(1, 'COMPS', 'Elements of Electrical and Electronics Engineering', 2022),
(1, 'COMPS', 'Programming in C', 2022),
(1, 'COMPS', 'Workshop-1', 2022),
(2, 'COMPS', 'Applied Mathematics 2', 2022),
(2, 'COMPS', 'Engineering Physics', 2022),
(2, 'COMPS', 'Engineering Mechanics', 2022),
(2, 'COMPS', 'Programming in Python', 2022),
(2, 'COMPS', 'Workshop-2', 2022),
(3, 'COMPS', 'Integral Transfer and Vector Calculus', 2022),
(3, 'COMPS', 'Data Structures', 2022),
(3, 'COMPS', 'Computer Organization and Architecture', 2022),
(3, 'COMPS', 'Object Oriented Programming Methodology', 2022),
(3, 'COMPS', 'Discrete Mathematics', 2022),
(3, 'COMPS', 'Digital Design', 2022),
(4, 'COMPS', 'Probability, Statistics and Optimizations Techniques', 2022),
(4, 'COMPS', 'Analysis of Algorithms', 2022),
(4, 'COMPS', 'Relational Database Management Systems', 2022),
(4, 'COMPS', 'Theory of Automata and Compiler Design', 2022),
(4, 'COMPS', 'Web Programming', 2022),
(4, 'COMPS', 'Mini Project', 2022),
(5, 'COMPS', 'Software Engineering', 2022),
(5, 'COMPS', 'Computer Networks', 2022),
(5, 'COMPS', 'Operating System', 2022),
(5, 'COMPS', 'Departmental Elective-I', 2022),
(5, 'COMPS', 'OET', 2022),
(5, 'COMPS', 'OEHM', 2022),
(5, 'COMPS', 'Full Stack Development Lab', 2022),
(6, 'COMPS', 'Digital Signal & Image Processing', 2022),
(6, 'COMPS', 'Information Security', 2022),
(6, 'COMPS', 'Artificial Intelligence', 2022),
(6, 'COMPS', 'Departmental Elective', 2022),
(6, 'COMPS', 'OET', 2022),
(6, 'COMPS', 'OEHM', 2022),
(1, 'IT', 'Applied Mathematics 1', 2022),
(1, 'IT', 'Engineering Chemistry', 2022),
(1, 'IT', 'Engineering Drawing', 2022),
(1, 'IT', 'Elements of Electrical and Electronics Engineering', 2022),
(1, 'IT', 'Programming in C', 2022),
(1, 'IT', 'Workshop-1', 2022),
(2, 'IT', 'Applied Mathematics 2', 2022),
(2, 'IT', 'Engineering Physics', 2022),
(2, 'IT', 'Engineering Mechanics', 2022),
(2, 'IT', 'Programming in Python', 2022),
(2, 'IT', 'Workshop-2', 2022),
(3, 'IT', 'Applied Mathematics 3', 2022),
(3, 'IT', 'Data Structures', 2022),
(3, 'IT', 'Data Communication and Network', 2022),
(3, 'IT', 'Database Management System', 2022),
(3, 'IT', 'Programming Language', 2022),
(4, 'IT', 'Applied Mathematics 4', 2022),
(4, 'IT', 'Information Theory and Coding', 2022),
(4, 'IT', 'Advanced Databases', 2022),
(4, 'IT', 'Web Programming-I', 2022),
(4, 'IT', 'Competitive Programming Language', 2022),
(5, 'IT', 'Theory Of Computation', 2022),
(5, 'IT', 'Operation System', 2022),
(5, 'IT', 'Information and Network Security', 2022),
(5, 'IT', 'Department Elective-I', 2022),
(5, 'IT', 'Web Programming-II Lab', 2022),
(5, 'IT', 'OET', 2022),
(5, 'IT', 'OEHM', 2022),
(6, 'IT', 'Object Oriented Software Engineering', 2022),
(6, 'IT', 'Modeling and Simulation', 2022),
(6, 'IT', 'Cloud Computing', 2022),
(6, 'IT', 'Departmental Elective', 2022),
(6, 'IT', 'OET', 2022),
(6, 'IT', 'OEHM', 2022),
(1, 'ETRX', 'Applied Mathematics 2', 2022),
(1, 'ETRX', 'Engineering Physics', 2022),
(1, 'ETRX', 'Engineering Mechanics', 2022),
(1, 'ETRX', 'Programming in Python', 2022),
(1, 'ETRX', 'Workshop-2', 2022),
(2, 'ETRX', 'Applied Mathematics 1', 2022),
(2, 'ETRX', 'Engineering Chemistry', 2022),
(2, 'ETRX', 'Engineering Drawing', 2022),
(2, 'ETRX', 'Elements of Electrical and Electronics Engineering', 2022),
(2, 'ETRX', 'Programming in C', 2022),
(2, 'ETRX', 'Workshop-1', 2022),
(3, 'ETRX', 'Mathematics for Electronics Engineering-I', 2022),
(3, 'ETRX', 'Electrical Networks', 2022),
(3, 'ETRX', 'Basic of Electronics Circuit', 2022),
(3, 'ETRX', 'Digital Electronics', 2022),
(3, 'ETRX', 'Signals and Systems', 2022),
(3, 'ETRX', 'Programming Laboratory', 2022),
(4, 'ETRX', 'Mathematics for Electronics Engineering-II', 2022),
(4, 'ETRX', 'Analog Electronics Circuits', 2022),
(4, 'ETRX', 'Control System Engineering', 2022),
(4, 'ETRX', 'Analog and Digital Communication', 2022),
(4, 'ETRX', 'Microcontroller and Applications', 2022),
(4, 'ETRX', 'Designing with Programmable Logic Lab Course', 2022),
(5, 'ETRX', 'Electromagnetic Engineering', 2022),
(5, 'ETRX', 'Digital Signal Processing', 2022),
(5, 'ETRX', 'Power Electronics', 2022),
(5, 'ETRX', 'Department Elective-I', 2022),
(5, 'ETRX', 'OET', 2022),
(5, 'ETRX', 'OEHM', 2022),
(5, 'ETRX', 'Virtual Instrumentation and Industrial Automation Lab Course', 2022),
(6, 'ETRX', 'Basics of VLSI', 2022),
(6, 'ETRX', 'Analog Integrated Circuits and Applications', 2022),
(6, 'ETRX', 'Introduction to Automation and Mechatronics', 2022),
(6, 'ETRX', 'Department Elective-II', 2022),
(6, 'ETRX', 'OET', 2022),
(6, 'ETRX', 'OEHM', 2022),
(1, 'EXTC', 'Applied Mathematics 2', 2022),
(1, 'EXTC', 'Engineering Physics', 2022),
(1, 'EXTC', 'Engineering Mechanics', 2022),
(1, 'EXTC', 'Programming in Python', 2022),
(1, 'EXTC', 'Workshop-2', 2022),
(2, 'EXTC', 'Applied Mathematics 1', 2022),
(2, 'EXTC', 'Engineering Chemistry', 2022),
(2, 'EXTC', 'Engineering Drawing', 2022),
(2, 'EXTC', 'Elements of Electrical and Electronics Engineering', 2022),
(2, 'EXTC', 'Programming in C', 2022),
(2, 'EXTC', 'Workshop-1', 2022),
(3, 'EXTC', 'Mathematics for Communication Engineering I', 2022),
(3, 'EXTC', 'Basic Electronic Circuits', 2022),
(3, 'EXTC', 'Digital Logic Design', 2022),
(3, 'EXTC', 'Microprocessor and Microcontroller', 2022),
(3, 'EXTC', 'Electrical Network Theory', 2022),
(3, 'EXTC', 'Data Structures and Analysis of Algorithms Laboratory', 2022),
(4, 'EXTC', 'Mathematics for Communication Engineering II', 2022),
(4, 'EXTC', 'Analog Electronics', 2022),
(4, 'EXTC', 'Communication Systems', 2022),
(4, 'EXTC', 'Signals and Systems', 2022),
(4, 'EXTC', 'Electromagnetic Field Theory', 2022),
(4, 'EXTC', 'Hardware Description Language Laboratory', 2022),
(5, 'EXTC', 'Digital Communication', 2022),
(5, 'EXTC', 'RF Filters and Antennas', 2022),
(5, 'EXTC', 'Digital Signal Processing', 2022),
(5, 'EXTC', 'Departmental Elective-I', 2022),
(5, 'EXTC', 'OET', 2022),
(5, 'EXTC', 'OEHM', 2022),
(5, 'EXTC', 'Advanced Microcontroller Laboratory', 2022),
(6, 'EXTC', 'Wireless Communication', 2022),
(6, 'EXTC', 'Computer Communication Networks', 2022),
(6, 'EXTC', 'Optical fibre Communication', 2022),
(6, 'EXTC', 'Departmental Elective-II', 2022),
(6, 'EXTC', 'OET', 2022),
(6, 'EXTC', 'OEHM', 2022),
(1, 'MECH', 'Applied Mathematics 2', 2022),
(1, 'MECH', 'Engineering Physics', 2022),
(1, 'MECH', 'Engineering Mechanics', 2022),
(1, 'MECH', 'Programming in Python', 2022),
(1, 'MECH', 'Workshop-2', 2022),
(2, 'MECH', 'Applied Mathematics 1', 2022),
(2, 'MECH', 'Engineering Chemistry', 2022),
(2, 'MECH', 'Engineering Drawing', 2022),
(2, 'MECH', 'Elements of Electrical and Electronics Engineering', 2022),
(2, 'MECH', 'Programming in C', 2022),
(2, 'MECH', 'Workshop-1', 2022),
(3, 'MECH', 'Mathematics for Mechanical Engineering-I', 2022),
(3, 'MECH', 'Strength of Materials', 2022),
(3, 'MECH', 'Material science and metallurgy', 2022),
(3, 'MECH', 'Thermodynamics', 2022),
(3, 'MECH', 'Production Engineering-I', 2022),
(3, 'MECH', 'Computer Aided Machine Drawing Laboratory', 2022),
(3, 'MECH', 'Machine Shop Practice-I', 2022),
(4, 'MECH', 'Mathematics for Mechanical Engineering-II', 2022),
(4, 'MECH', 'Theory of Machines-I', 2022),
(4, 'MECH', 'Fluid Mechanics', 2022),
...
(5, 'MECH', 'Open Elective', 2022),
(5, 'MECH', 'Open Elective Humanities', 2022),
(5, 'MECH', 'Industrial Electronics Laboratory', 2022),
(6, 'MECH', 'Elements of Machine Design', 2022),
(6, 'MECH', 'Energy Conversion-II', 2022),
(6, 'MECH', 'Computer Aided Engineering', 2022),
(6, 'MECH', 'Departmental Elective-II', 2022),
(6, 'MECH', 'Open Elective', 2022),
