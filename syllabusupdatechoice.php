...
<body class="img">
    <h1 class="admintitle">Syllabus Update</h1>
    <!-- <br><br> -->
    <div class="updatebtn">
        <button class="userup" onclick="window.location.href='syllabusupdate.php'">Single Entry</button>
        <button class="pdfup" onclick="window.location.href='syllabusupdate2.php'">Multiple Entry</button>
    </div>
