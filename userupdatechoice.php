...
<body class="img">
    <h1 class="admintitle">User Update</h1>
    <!-- <br><br> -->
    <div class="updatebtn">
        <button class="userup" onclick="window.location.href='userupdate.php'">Single Entry</button>
        <button class="pdfup" onclick="window.location.href='userupdate2.php'">Multiple Entry</button>
    </div>
